package problem10PopulationCounter;
...
public class PopulationCounter {
	...
	private static void printResult(Map<String, Map<String, Long>> world, Map<String, Long> totalPeople,
	...
	private static void putPopulationInWorld(Map<String, Map<String, Long>> world, String town, String country,
